...
case $ans in
  ...
  4 ) git init; git add -A; git commit -m 'Added Files'; git remote add origin git@github.com:TheRealUnBot/MinecraftOfVPS.git; echo yo; git push -u -f origin main; exit;;
esac
