...
public class Minecraft implements Runnable {
	...
	public String getServerURI() {
		return this.getNetHandler() != null ? this.getNetHandler().getNetManager().getServerURI() : "Uh oh, no connection.";
	}
	...
	public void loadWorld(WorldClient par1WorldClient, String par2Str) {
		...
		if (par1WorldClient != null) {
			...
			if(this.gameSettings.showCoordinates) {
				displayEaglercraftText(EnumChatFormatting.LIGHT_PURPLE + "Note: use F+6 to hide the coordinates off of the screen");
			}else {
				displayEaglercraftText(EnumChatFormatting.LIGHT_PURPLE + "Note: use F+6 to show your coordinates on the screen (absolutley recommended)");
			}
